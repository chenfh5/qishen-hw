...
import io.github.chenfh5.ast.ast4.ExpFactory;
import io.github.chenfh5.ast.ast4.StmtFactory;
...
public class AST4Tests {
    ...
    @Test
    public void test1() {
        ExpFactory expFactory = ExpFactory.getInstance();
        StmtFactory stmtFactory = StmtFactory.getInstance();
